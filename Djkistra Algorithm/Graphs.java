...
public class Graphs {
  ...
  * Retorno: void
  *************************************************************** */
  public void addEdge(String source, String destiny, char id, int x1, int y1, int x2, int y2, int weight) {
    ...
    Edge e = new Edge(sour, dest, id, x1, y1, x2, y2, weight);
    edges.add(e);

    sour.adjacencyNode.add(dest);
    dest.adjacencyNode.add(sour);
    sour.addIncidentList(e);
    sour.addIncidentList(e);
