	...
	public void run2(){
	    ...
	    @Override
	  	public void run() {
		      ...
		      FloodRouting.graphs.getNode(idDest).setReceive();
			      hopLimit--;
			      image.setVisible(false);
			      flood.arrive(FloodRouting.graphs.getNode(idDest), whoSent, tela, hopLimit);
